...
export const translations: Record<"fr" | "en" | "es", Dictionary> = {
  fr: {
    ...
    footer: {
      ...
      addressLine1: "Socogim lot N° 111",
      addressLine2: "Près de l'avenue de l'aéroport",
      addressLine3: "BP 1024 · Nouadhibou",
      addressLine4: "Mauritanie",
    ...
    contact: {
      ...
      addressValue: "Socogim lot N° 111, près de l'avenue de l'aéroport, BP 1024, Nouadhibou, Mauritanie",
      form: {
  ...
  en: {
    ...
    footer: {
      ...
      addressLine1: "Socogim lot N° 111",
      addressLine2: "Near the airport avenue",
      addressLine3: "BP 1024 · Nouadhibou",
      addressLine4: "Mauritania",
    ...
    contact: {
      ...
      addressValue: "Socogim lot N° 111, near the airport avenue, BP 1024, Nouadhibou, Mauritania",
      form: {
  ...
  es: {
    ...
    footer: {
      ...
      addressLine1: "Socogim lote N.º 111",
      addressLine2: "Cerca de la avenida del aeropuerto",
      addressLine3: "BP 1024 · Nouadhibou",
      addressLine4: "Mauritania",
    ...
    contact: {
      ...
      addressValue: "Socogim lote N.º 111, cerca de la avenida del aeropuerto, BP 1024, Nouadhibou, Mauritania",
      form: {
